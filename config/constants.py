...
NAV_ITEMS: list[dict[str, str | None]] = [
    ...
    {"label": "Integrations", "path": "pages/9_Integration.py", "icon": "🔌", "required_permission": "view_integrations"},
    {"label": "Operations", "path": "pages/10_Operations.py", "icon": "⚙️", "required_permission": "manage_platform"},
]
